...
public final class ObservationSchema {
    ...
    /**
     * The layout as JSON, handed to the training side when it connects.
     *
     ...
     * whichever slot used to hold it and plays badly for reasons nobody can find. Sending the layout means there is only
     * ever one copy of it, and this class is it.
     */
