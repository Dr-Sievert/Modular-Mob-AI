...
| `test.ps1 -Mechanics` | `All 21 required tests passed` | bows, crossbows, shields, axes, mining, placing, use slowdown and damage payment follow a player's rules, and what the observation says about a use and about what is shot at the agent |
